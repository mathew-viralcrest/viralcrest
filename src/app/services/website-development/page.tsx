                ...
                <div className="container mx-auto px-6 relative z-10">
                    <div className="text-center max-w-4xl mx-auto">
                        <h1 className="text-5xl md:text-6xl font-bold text-slate-900 tracking-tight mb-6 font-outfit">
                            Website <span className="text-[#5057e6]">Development</span>
                        </h1>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                        <div>
                            <h2 className="text-3xl md:text-5xl font-bold text-slate-900 mb-6 leading-tight">
                                Building Your <br />
                                <span className="text-[#5057e6]">Digital Foundation</span>
                            </h2>
                        ...
                        <div className="relative">
                            <div className="absolute inset-0 bg-gradient-to-tr from-[#5057e6]/20 to-slate-50 rounded-3xl transform rotate-3 scale-105 -z-10"></div>
                            <img
